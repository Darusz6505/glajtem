...
/**
*
* wtyczka dedykowana : referencje : rotgryf.pl ver: 2013
*
*
...
$r->linkName = 'zobacz stronę'; 			//'czytaj dalej';	//-nazwa odnośnika zajawki do całego tekstu z pominieciem pliku wersji
...
$r->zajawki(0, 400, true, 'adres'); 			//-[limit ilości zajawek, 0=bez limitu][limit długości tekstu zajawki, -1 = linki z tytułu][zdjęcia losowo]

$szab = $r->wynik();


// Test::tracer(__FILE__, __METHOD__, __FUNCTION__, __LINE__, 'd_zajawki_blo:szab', $szab);
